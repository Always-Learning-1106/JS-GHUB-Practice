...
// const currMap = currencies.forEach((value, key, map) => {
//   console.log(`${value}: ${key}`);
// });
// const currSet = new Set(["USD", "GBP", "EUR"]);
// const setCurr = currSet.forEach((value, _, set) => {
...
const juliaDogs = julia.slice(1, 3);
console.log(juliaDogs);
const kate = [4, 1, 15, 8, 3];
const concatDogs = juliaDogs.concat(kate);

// const concatDogs = [...juliaDogs,...kate]
const checkDogs = function (concatDogs) {
  concatDogs.forEach((dog, i) => {
    dog <= 3
      ? console.log(`Dog ${i + 1} is a puppy and ${dog} years old`)
      : console.log(`Dog ${i + 1} is an adult and is ${dog} years old`);
  });
};
checkDogs(concatDogs);
